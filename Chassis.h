...
public:
     ...
     * 
     * @param targetCount Target angle expressed in encoder count
     * @param targetSeconds Target seconds to complete turn
     * */
    void turnWithTime(int turnAngle, float targetSeconds);
